...
import CopyrightSocialLanguage from "../../CopyrightSocialLanguage"; // plasmic-import: KVmV2IPmCBZ6tx/component
...
import * as sty from "./PlasmicFooter.module.css"; // plasmic-import: NmbnAqSDZSY-2F/css
          ...
          defaultContents: (
            <React.Fragment>
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__w5Erf)}
              >
                <div
                ...
                <input
                  className={classNames(defaultcss.input, sty.textbox__vrloD)}
                ...
                <Button
                  className={classNames("__wab_instance", sty.button__qmma4)}
              ...
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__v0Lf)}
              >
                <div
                  className={classNames(
                    defaultcss.all,
                ...
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.box___6BDd4)}
                >
                  <Button slot={"Order status"}>
                    <Icon22Icon
                      className={classNames(defaultcss.all, sty.svg__cUFkq)}
                      role={"img"}
                    />
                  </Button>

                  <Button
                    className={classNames("__wab_instance", sty.button__vDrf)}
                    slot={
                      <div
                        className={classNames(
                          defaultcss.all,
                  ...
                  >
                    <Icon21Icon
                      className={classNames(defaultcss.all, sty.svg__bnbV)}
                      role={"img"}
                    />
                  </Button>

                  <Button
                    className={classNames("__wab_instance", sty.button__eWjof)}
                    slot={
                      <div
                        className={classNames(
                          defaultcss.all,
                  ...
                  >
                    <Icon20Icon
                      className={classNames(defaultcss.all, sty.svg__gv1BO)}
                      role={"img"}
                    />
                  </Button>
                </p.Stack>
              ...
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__edZm)}
              >
                <div
                  className={classNames(
                    defaultcss.all,
                ...
                <div className={classNames(defaultcss.all, sty.box__qk3Dx)}>
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.box__sBm3L)}
                  >
                  ...
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.box__uxfYs)}
                  >
                    <Button
                      className={classNames(
                        "__wab_instance",
