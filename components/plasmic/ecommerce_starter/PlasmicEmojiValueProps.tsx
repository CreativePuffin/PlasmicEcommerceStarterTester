...
import * as sty from "./PlasmicEmojiValueProps.module.css"; // plasmic-import: Eymnx1K8g7ggxk/css
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.box__x0PS7)}
          >
            <Value
              className={classNames("__wab_instance", sty.value__mPt47)}
              slot={
                <Icon12Icon
                  className={classNames(defaultcss.all, sty.svg___1B49W)}
                  role={"img"}
                />
              }
            >
            ...
            <Value
              className={classNames("__wab_instance", sty.value__jXIof)}
              slot={
                <Icon13Icon
                  className={classNames(defaultcss.all, sty.svg__gtOoH)}
                  role={"img"}
                />
              }
            >
            ...
            <Value
              className={classNames("__wab_instance", sty.value__j2WZt)}
              slot={
                <Icon14Icon
                  className={classNames(defaultcss.all, sty.svg__lbV0R)}
                  role={"img"}
                />
              }
            >
